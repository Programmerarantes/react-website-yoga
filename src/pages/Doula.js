...
function Doula() {
  return (
    <>
      ...
      <section className='doula--containertwo'>
        <div className='doula--contenttwo'>
          <h3>Qual a importância ?</h3>
          <p>Consultoria com gestantes sobre regimes de bem-estar, incluindo exercícios, alimentação balanceada e suplementos</p>
          <p>Ensinar técnicas de relaxamento e respiração para praticar antes e durante o parto</p>
          <p>Aconselhamento sobre vínculo pré e pós-natal entre pais e filhos</p>
          <p>Cuidar de mulheres grávidas com condições de alto risco, como pré-eclâmpsia ou gravidez multifetal</p>
          <p>Coordenar tratamentos e cuidados médicos recomendados com médicos e enfermeiros</p>
